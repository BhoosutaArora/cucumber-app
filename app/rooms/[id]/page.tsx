    ...
    <main className="min-h-screen bg-green-50 font-sans">
      ...
      <div className="pt-20 pb-16 px-4 md:px-16 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[
            { label: 'Price', value: `₹${room.price?.toLocaleString() || 'TBD'}` },
            { label: 'Seats Left', value: `${(room.seats_total || 10) - (room.seats_filled || 0)}` },
        ...
        <div className="bg-white rounded-2xl p-5 mb-6 border border-green-100">
          ...
          <div className="mt-4 bg-green-50 rounded-xl p-3 border border-green-100">
            <p className="text-xs text-green-700 font-medium">🔑 Pay ₹199 to unlock full itinerary, hotel details, and meet your travel buddies!</p>
          </div>
        </div>
        ...
        <div className="sticky bottom-4">
          ...
          >
            Join This Room 🥒 - ₹199 to unlock
          </a>
          <p className="text-center text-xs text-gray-400 mt-2">Refundable within 24 hours if you change your mind</p>
        </div>
